...
def whatsapp_send_message(contact_name, message_text):
    """Send a message to a contact on WhatsApp Web using Playwright."""
    ...
    with sync_playwright() as p:
        ...
        search.click()
        search.fill("")
        search.type(contact_name, delay=50)
        ...
        message_box.click()
        message_box.type(message_text, delay=30)
        ...
        context.close()
    return "Message sent to WhatsApp contact."